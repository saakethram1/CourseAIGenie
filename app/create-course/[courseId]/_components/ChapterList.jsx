...
const ChapterList = ({course,refresh,edit=true}) => {
  return (
    <div className='mt-3'>
      ...
      <div className='mt-2'>
        ...
        className='border p-5 rounded-lg mb-2 flex items-center justify-between'>
          <div className='flex gap-5 items-center'>
           ...
           <div>
            <h2 className='font-medium text-lg'>{chapter?.ChapterName}{edit &&<EditChapters course={course} index={index} refresh={refresh} />}</h2>
